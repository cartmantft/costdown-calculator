...
## Active Technologies
- TypeScript 5.9, React 18 + Vite 7 (Granite wrapper), @toss/tds-mobile 2.1.2, @apps-in-toss/web-framework 1.5.0, @emotion/react 11.x (001-inline-currency-toggle)
- Browser localStorage for currency/default history (001-inline-currency-toggle)
